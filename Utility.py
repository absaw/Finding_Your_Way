...
def main():
    ...
    #============================================
    file_path='/Users/abhishek.sawalkar/Library/Mobile Documents/com~apple~CloudDocs/AI Project/Finding_Your_Way/Schematics/Schema_1.txt'
            ...
            for pos_2_r in range(0,n_row):
                for pos_2_c in range(0,n_col):
                    ...
                    if key not in dist_dict.keys():
                        ...
                        state_dict[(pos_1_r,pos_1_c,pos_2_r,pos_2_c)]=[0,0] #reward, utility
                        final_utility[(pos_1_r,pos_1_c,pos_2_r,pos_2_c)]=0
            ...
            for pos_2_r in range(0,n_row):
                for pos_2_c in range(0,n_col):
                    if maze[pos_1_r,pos_1_c] != 5 and maze[pos_2_r,pos_2_c] != 5:
                        ...
                        key=(key[0][0],key[0][1],key[1][0],key[1][1])
                        if key not in dist_dict.keys():
                            distance=len(get_bfs_path(maze, n_row, n_col, (key[0],key[1]), (key[1],key[2])))
                            # print(distance)
                            dist_dict[key]=distance-1
    # print(dist_dict)
    print(len(dist_dict))
